...
// RUN: %hermes -type-annotation-file=%annotation_file -Xhermes-internal-test-methods -Xes6-proxy -non-strict -O -target=HBC %s | %FileCheck --match-full-lines %s
// RUN: %hermes -type-annotation-file=%annotation_file -Xhermes-internal-test-methods -Xes6-proxy -non-strict -O0 -target=HBC -lazy %s | %FileCheck --match-full-lines %s
