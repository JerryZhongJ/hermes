...
// RUN: %hermes -type-annotation-file=%annotation_file -g --lazy --Xhermes-internal-test-methods -O %s | %FileCheck %s
// RUN: %hermes -type-annotation-file=%annotation_file -g --lazy --Xhermes-internal-test-methods -O0 %s | %FileCheck %s
