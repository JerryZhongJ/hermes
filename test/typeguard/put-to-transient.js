...
// RUN: %hermes -type-annotation-file=%annotation_file -target=HBC -Wno-undefined-variable %s | %FileCheck --match-full-lines %s
// RUN: %hermes -type-annotation-file=%annotation_file -target=HBC -Wno-undefined-variable -emit-binary -out %t.hbc %s && %hermes -type-annotation-file=%annotation_file %t.hbc | %FileCheck --match-full-lines %s
"use strict";
