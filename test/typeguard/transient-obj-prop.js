...
// RUN: %hermes -type-annotation-file=%annotation_file -O -Wno-direct-eval -non-strict %s | %FileCheck --match-full-lines %s
// RUN: %hermes -type-annotation-file=%annotation_file -O -Wno-direct-eval -non-strict -emit-binary -out %t.hbc %s && %hermes -type-annotation-file=%annotation_file %t.hbc | %FileCheck --match-full-lines %s
