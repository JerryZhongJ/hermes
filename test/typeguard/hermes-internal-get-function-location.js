...
// RUN: %hermes -type-annotation-file=%annotation_file -g %s \
// RUN:   | %FileCheck --match-full-lines %s -check-prefix JS
// RUN: %hermes -type-annotation-file=%annotation_file -O -emit-binary -output-source-map -out %t.hbc %s && %hermes -type-annotation-file=%annotation_file %t.hbc \
