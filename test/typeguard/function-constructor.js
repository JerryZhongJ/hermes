...
// RUN: %hermes -type-annotation-file=%annotation_file -Xes6-proxy -O0 -Wno-direct-eval %s | %FileCheck --match-full-lines %s
// RUN: %hermes -type-annotation-file=%annotation_file -Xes6-proxy -O -Wno-direct-eval %s | %FileCheck --match-full-lines %s
// RUN: %hermes -type-annotation-file=%annotation_file -Xes6-proxy -lazy -O0 -Wno-direct-eval %s | %FileCheck --match-full-lines %s
"use strict";
