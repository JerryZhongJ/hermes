...
// RUN: %hermes -type-annotation-file=%annotation_file -O -gc-max-heap=8M -gc-init-heap=8M %s | %FileCheck --match-full-lines %s
// RUN: %shermes -type-annotation-file=%annotation_file -exec %s -Wx,-gc-max-heap=8M,-gc-init-heap=8M | %FileCheck --match-full-lines %s
