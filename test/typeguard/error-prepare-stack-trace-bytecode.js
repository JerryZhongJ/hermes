...
// RUN: %hermes -type-annotation-file=%annotation_file -O -fstrip-function-names -finline -output-source-map -target=HBC -emit-binary -out=%t.hbc %s && %hermes -type-annotation-file=%annotation_file -O -b %t.hbc | %FileCheck --match-full-lines -D=HBC_FILE=%t.hbc %s
"use strict";
