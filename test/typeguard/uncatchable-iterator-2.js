...
// RUN: (! %hermes -type-annotation-file=%annotation_file -O -target=HBC %s 2>&1 ) | %FileCheck %s
// RUN: %hermes -type-annotation-file=%annotation_file -O -target=HBC -emit-binary -out %t.hbc %s && (! %hermes -type-annotation-file=%annotation_file %t.hbc 2>&1 ) | %FileCheck %s
