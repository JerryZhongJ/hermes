...
// RUN: (%hermesc -type-annotation-file=%annotation_file -O0 -target=HBC %s --dump-bytecode 2>&1 || true) | %FileCheck --match-full-lines %s
// RUN: (%hermes -type-annotation-file=%annotation_file -O0 -target=HBC %s 2>&1 || true) | %FileCheck --match-full-lines %s
// DISABLED: %hermes -type-annotation-file=%annotation_file -O0 -target=HBC %s -lazy 2>&1 | %FileCheck --match-full-lines %s --check-prefix=LAZY
// XFAIL: windows
