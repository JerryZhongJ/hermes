...
// RUN: ulimit -s 1024 && %hermes -type-annotation-file=%annotation_file -Xhermes-internal-test-methods -Xes6-proxy -non-strict -O -target=HBC %s | %FileCheck --match-full-lines %s
