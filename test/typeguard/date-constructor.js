...
// RUN: TZ="MST+7" %hermes -type-annotation-file=%annotation_file -O %s | %FileCheck --match-full-lines %s
// RUN: TZ="MST+7" %shermes -type-annotation-file=%annotation_file -exec %s | %FileCheck --match-full-lines %s
"use strict";
