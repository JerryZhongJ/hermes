...
// RUN: %hermes -type-annotation-file=%annotation_file -test262 -O %s | %FileCheck --match-full-lines %s
// RUN: %shermes -type-annotation-file=%annotation_file -test262 -O -exec %s | %FileCheck --match-full-lines %s
